...
export const CardFood = ({ title, price, onCardClick, image, onAddCardToCartClick }) => {
  return (
    <div className="py-2 px-4 pb-8 rounded-lg shadow-md max-w-sm">
      <div className="flex flex-col items-center">
        <img src={image} alt={title} className="max-h-52" /> {/* Ajuste a altura da imagem conforme necessário */}
